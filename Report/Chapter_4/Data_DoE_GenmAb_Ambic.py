...
import pandas as pd
import numpy as np
GenmAb_data_AMBIC = pd.read_excel(r'C:\Users\deeprob\Chemical Projects\Bio-modelling\Report\Chapter_4\Yu-DoE-data-compilation_LS.xlsx',sheet_name='GenmAb AMBIC',skiprows=2)
