...
TCD_Amb = parsingfunction(GenmAb_data_AMBIC,11,19,1,6)


# In[14]:


VCD_Amb = parsingfunction(GenmAb_data_AMBIC,11,19,7,12)


# In[15]:


Glucose_Amb = parsingfunction(GenmAb_data_AMBIC,11,19,13,18)


# In[17]:


Lactate_Amb = parsingfunction(GenmAb_data_AMBIC,11,19,19,24)


# In[18]:


Ammonia_Amb = parsingfunction(GenmAb_data_AMBIC,11,19,25,30)


# In[19]:


IgG_Amb = parsingfunction(GenmAb_data_AMBIC,11,19,31,36)


# In[26]:


Glutamine_Amb = parsingfunction(GenmAb_data_AMBIC,22,30,1,6).fillna(1150.0)
